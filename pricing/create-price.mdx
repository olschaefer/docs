...
If you, for example, create one price billed monthly and another one billed annually, Nadles will do exactly that: the customer will be charged for both prices according to their billing periods.
...
Recurring prices can be either metered or unmetered.
