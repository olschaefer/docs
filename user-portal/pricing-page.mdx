...
If you would like to embed the product list in your website, you can do that by adding 

```?embedded=1``` 

to the pricing page URL, so that the URL looks as follows:

```
https://<your-user-portal-domain>/pricing/?embedded=1
```
...
```
<iframe
    src="https://<your-user-portal-domain>/pricing/?embedded=1"
    frameborder="0" 
    width="100%" 
    height="330px" 
