...
<Tip>
Try creating products from [templates](/products/create#product-templates) to see different billable metrics configurations.
</Tip>
...
1. To limit usage in free products.
  ...
  When you add an unmetered price to the product, you, at the same time, define a usage limit.
