...
Later, you can configure Nadles API Gateway to use a custom domain for your API, e.g. [https://api.mydomain.com](https://api.mydomain.com). [Learn more](https://docs.nadles.com/api-management/custom-domains/).